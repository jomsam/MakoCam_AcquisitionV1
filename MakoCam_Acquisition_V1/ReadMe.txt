========================================================================
    APLICACIÓN DE CONSOLA: MakoCam_Acquisition_V1 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación MakoCam_Acquisition_V1.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación MakoCam_Acquisition_V1.


MakoCam_Acquisition_V1.vcxproj
...
MakoCam_Acquisition_V1.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado MakoCam_Acquisition_V1.pch y un archivo de tipos 
